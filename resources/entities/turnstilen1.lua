...
function turnstilen1.register()
  game_entityregistersymbolforname("1^", "turnstilen1")
end

-------------------------------------------------------------------------------
turnstilen1.initial = {}

function turnstilen1.initial.init(id, attr)
  entity_setrenderable(id, true)
  entity_setcollidable(id, true)
  entity_setmesh(id, "cube.lua")
  entity_settexture(id, "turnstilen1.png")
  if turnstilee.activesound == nil then turnstilee.activesound = sound_nametoid("buzz.wav") end
end

function turnstilen1.initial.update(id, tpf)
end

function turnstilen1.initial.collision(id, oid)
...
function turnstilen1.initial.event(id, evt)
end

function turnstilen1.initial.render(id)
end
