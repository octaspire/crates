...
function turnstilew.register()
  game_entityregistersymbolforname("T<", "turnstilew")
end

-------------------------------------------------------------------------------
turnstilew.initial = {}

function turnstilew.initial.init(id, attr)
  entity_setrenderable(id, true)
  entity_setcollidable(id, true)
  entity_setmesh(id, "cube.lua")
  entity_settexture(id, "turnstilew.png")
  if turnstilee.activesound == nil then turnstilee.activesound = sound_nametoid("buzz.wav") end
end

function turnstilew.initial.update(id, tpf)
end
...
function turnstilew.initial.event(id, evt)
end

function turnstilew.initial.render(id)
end
