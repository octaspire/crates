...
function turnstilee.register()
  game_entityregistersymbolforname("T>", "turnstilee")
end

-------------------------------------------------------------------------------
turnstilee.initial = {}

function turnstilee.initial.init(id, attr)
  entity_setrenderable(id, true)
  entity_setcollidable(id, true)
  entity_setmesh(id, "cube.lua")
  entity_settexture(id, "turnstilee.png")
  if turnstilee.activesound == nil then turnstilee.activesound = sound_nametoid("buzz.wav") end
end

function turnstilee.initial.update(id, tpf)
end

function turnstilee.initial.collision(id, oid)
...
function turnstilee.initial.event(id, evt)
end

function turnstilee.initial.render(id)
end
