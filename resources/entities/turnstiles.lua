...
function turnstiles.register()
  game_entityregistersymbolforname("T.", "turnstiles")
end

-------------------------------------------------------------------------------
turnstiles.initial = {}

function turnstiles.initial.init(id, attr)
  entity_setrenderable(id, true)
  entity_setcollidable(id, true)
  entity_setmesh(id, "cube.lua")
  entity_settexture(id, "turnstiles.png")
  if turnstilee.activesound == nil then turnstilee.activesound = sound_nametoid("buzz.wav") end
end

function turnstiles.initial.update(id, tpf)
end

function turnstiles.initial.collision(id, oid)
...
function turnstiles.initial.event(id, evt)
end

function turnstiles.initial.render(id)
end
